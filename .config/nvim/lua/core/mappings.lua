...
nmap({
	"<leader>dg",
	":DapToggleBreakpoint<CR>:DapContinue<CR>",
	{ desc = "[D]ebu[g]: Set breakpoint and dap continue" },
})
...
-- TODO: Figure out why ripgrep doesn't seem to be working
M.ripgrep_mappings = {
	--  alias for above
...
-- TODO: Get this working with new setup
---@type LazyKeys[]
-- M.vim_test_mappings = {
